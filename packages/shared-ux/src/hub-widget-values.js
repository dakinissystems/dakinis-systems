/**
 * Map hub.v1_get_dashboard / internal API payload → widget card values.
 ...
 * @param {Record<string, { value?: string; status?: string }>} widgetValues
 */
