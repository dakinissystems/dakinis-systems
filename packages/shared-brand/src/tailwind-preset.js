/**
 * Tailwind theme bridge for DES tokens.
 * Usage (CJS apps):
 *   const { desTailwindThemeExtend } = require("@dakinis/shared-brand/tailwind-preset");
 *   theme: { extend: desTailwindThemeExtend }
 *
 * Prefer CSS vars so dark/light + product accent stay live.
 */

/** @type {Record<string, string>} */
export const desTailwindColors = {
  surface: {
...
export const desTailwindThemeExtend = {
...
/** Default export for `require(...).default || ...` flexibility */
export default desTailwindThemeExtend;
