...
export const DES_PATTERNS = {
  ...
  search: {
    ...
    note: "Hub Ctrl+K + dakinis-search API",
  },
  crud: { status: "documented", surfaces: [0, 1], layout: "list-detail" },
  wizards: { status: "planned", module: "@dakinis/shared-onboarding" },
  dashboards: {
    status: "ready",
    module: "@dakinis/shared-ux",
    export: "DashboardPattern",
    shell: "DashboardTemplate (@dakinis/shared-layouts)",
  },
  forms: { status: "ready", module: "@dakinis/shared-ux", export: "FormPattern" },
  ...
  notifications: {
    status: "ready",
    module: "@dakinis/shared-ux/react/NotificationsCenter.jsx",
  },
  chat: { status: "ready", module: "@dakinis/shared-ux", export: "ChatPattern" },
