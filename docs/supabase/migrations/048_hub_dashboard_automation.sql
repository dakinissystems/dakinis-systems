-- 048 — Hub Mi día: automation metrics + stock bajo + timeline enriquecido
-- Ejecutar tras 028 (hub.v1_get_dashboard ampliado). Idempotente.
...
VALUES ('hub', 'v1_get_dashboard', 1, true, '048_hub_dashboard_automation.sql')
...
COMMENT ON FUNCTION hub.v1_get_dashboard IS
  'Payload Hub Mi día — stream, automation, lifeflow, core, akoenet, ai, timeline';
