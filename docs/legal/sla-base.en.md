...
**Service availability target:** 99.5% monthly (excluding scheduled maintenance announced with reasonable notice).
...
Force majeure, third-party failures outside our reasonable control (e.g. cloud provider outages), announced maintenance, and misuse of the service.

## Credits

Service credits, if any, are governed by the commercial contract with the customer.
